...
label_mapping = np.load("label_mapping_v2.npy", allow_pickle=True)

models = {
    'SVM':               joblib.load("svm_model_v2.pkl"),
    'Random Forest':     joblib.load("rf_model_v2.pkl"),
    'k-NN':              joblib.load("knn_model_v2.pkl"),
    'Gradient Boosting': joblib.load("gb_model_v2.pkl"),
}
...
plt.savefig("eval_v2_confusion_matrices.png", dpi=300)
plt.show()
...
# ==================== ZUSAMMENFASSUNG ====================
print(f"\n{'='*50}")
print("ZUSAMMENFASSUNG V2 (PowerTransformer_Balanced + Balanced)")
print(f"{'='*50}")
